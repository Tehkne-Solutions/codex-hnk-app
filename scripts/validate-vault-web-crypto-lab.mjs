...
const invariants = [
  ...
  ['Deterministic Native-compatible vector frozen', vectors.includes('HNK Native ↔ Web vector 001') && vectors.includes('157c92b5e1b1da403003fe1fd244bb7d46f3a3f085bc407373388491055a4020')],
  ...
  ['Day 001 remains disconnected from experimental crypto lab', !day001.includes('@hnk/vault-web-crypto-lab')],
